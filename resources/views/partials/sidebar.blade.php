...
{{--    <div style="overflow-y: scroll">--}}
        ...
        <br>
        <div>
            <a class="dropdown-item " href="#" data-toggle="collapse" data-target="#config"><i
                    class="fas fa-cubes"></i> Configuración <i class="fas fa-angle-down"></i></a>
            <div id="config" class="collapse">
                <div class="row">
                    <div class="col-md-12 offset-3" style="border-left: 1px solid black; height: 25px">
                        <span><a href="{{ route('configs.m-units') }}"
                                 class="sidebar-item">Unidades de medida</a></span>
                    </div>
                </div>
            </div>
        </div>
