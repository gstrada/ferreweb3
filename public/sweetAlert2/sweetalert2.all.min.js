!function (t, e) {
    ...
    var V = "SweetAlert2:", R = function (t) {
        ...
        F = t(["success", "warning", "info", "question", "error"]), z = function () {
    ...
    var wt = {promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap},
        Ct = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], kt = function (t) {
            ...
            var e = At(t.input), n = Bt[t.input](e, t);
        ...
        if (e) {
            ...
            if (n && !j(e, n.hideClass.popup)) {
                ...
                ut(i, n.showClass.backdrop), st(i, n.hideClass.backdrop), function (t, e, n) {
                    var o = z(), i = gt && et(e), r = n.onClose, a = n.onAfterClose;
    ...
    var Ce = function (t, e) {
        ...
        }, He = ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"], Ie = ["Escape", "Esc"],
        je = function (t, e, n) {
    ...
    var Ze, Qe = function (t) {
        ...
        hideLoading: Jt, disableLoading: Jt, getInput: function (t) {
            var e = wt.innerParams.get(t || this), n = wt.domCache.get(t || this);
            return n ? Z(n.content, e.input) : null
        }, close: ie, closePopup: ie, closeModal: ie, closeToast: ie, enableButtons: function () {
            ...
            var e = function (t) {
                var e = c({}, Kt.showClass, t.showClass), n = c({}, Kt.hideClass, t.hideClass), o = c({}, Kt, t);
            ...
            var t = W(), n = wt.innerParams.get(this);
